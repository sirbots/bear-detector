...
data-base-url="/"
data-file-path="fastbook/utils.py"

  
    data-jupyter-api-token="DrRfcjNjjlh1gIt9y2WiX9u7CyGiqQwY"
...
<div id="header" role="navigation" aria-label="Top Menu">
  ...
  <div id="ipython_notebook" class="nav navbar-brand"><a href="/lab?token=DrRfcjNjjlh1gIt9y2WiX9u7CyGiqQwY" title='dashboard'>
